...
import { SignIn, UserButton, useUser, useClerk, useAuth } from "@clerk/nextjs";
          ...
          <div className="grid min-h-[500px] md:min-h-[600px] lg:min-h-[700px] lg:grid-cols-2 h-full">
            <div className="brand-side relative m-0 rounded-none bg-black/10 text-white border-r border-gray-700 h-full hidden lg:block">
              <div className="p-4 sm:p-6 md:p-12 flex flex-col h-full">
                <div>
                  <h1 className="mb-3 md:mb-4 text-3xl sm:text-4xl md:text-6xl font-medium">
                    Welcome Back to Story Craft AI
                  </h1>
                  <p className="mb-6 sm:mb-8 md:mb-12 text-base sm:text-lg md:text-xl text-muted-foreground/70">
                    Sign in to unleash your creativity and publish AI-enhanced
                    stories
                  </p>
                    ...
                    {[
                      {
                        ...
                        desc: "Craft unique tales with intelligent assistance",
                      },
                      {
                        icon: <Users size={16} />,
                        title: "Story Community",
                        desc: "Connect with writers worldwide",
                      },
                      {
                        icon: <Sparkles size={16} />,
                        title: "Creative Boost",
                        desc: "Explore AI-powered writing prompts",
                      },
                      {
                        icon: <ShieldCheck size={16} />,
                        title: "Safe Publishing",
                        desc: "Securely share your work with confidence",
                      },
