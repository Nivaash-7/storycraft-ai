        ...
        <CardContent className="pt-6 pb-4 px-6">
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              StoryCraft AI is not optimized for mobile devices yet. For the
              best experience, please use a tablet or computer. We are working
              on launching a mobile application soon!
            </p>
